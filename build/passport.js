...
_passport["default"].use(new _passportGithub["default"]({
  ...
  callbackURL: process.env.PRODUCTION ? "https://damp-forest-52392.herokuapp.com".concat(_routes["default"].githubCallback) : "http://localhost:4000".concat(_routes["default"].githubCallback)
}, _userController.githubLoginCallback));

_passport["default"].use(new _passportFacebook["default"]({
  clientID: process.env.FB_ID,
  clientSecret: process.env.FB_SECRET,
  callbackURL: "https://c8e1ec1a.ngrok.io".concat(_routes["default"].facebookCallback),
